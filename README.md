...
The code for the chat app can be found at the public [GitHub](https://github.com/olawuwo-abideen/todolist). Either clone the repo to a local folder on your machine or
